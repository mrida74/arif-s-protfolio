...
return (
     <div className="hidden md:flex fixed left-4 top-1/2 -translate-y-1/2 z-50 flex-col gap-6 items-center">
            <Link href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 bg-white dark:bg-gray-800 rounded-full p-2 shadow-lg">
            ...
            <Link href="https://linkedin.com/in/arif-mrida" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:text-blue-900 bg-white dark:bg-gray-800 rounded-full p-2 shadow-lg">
